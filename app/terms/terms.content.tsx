    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              O Florim é um aplicativo de organização financeira familiar que permite aos usuários registrar manualmente receitas, despesas, metas de economia e lembretes, diretamente no aplicativo ou por mensagens de texto e áudio no WhatsApp.
            </p>
            <p>
              Mensagens enviadas pelo WhatsApp são processadas por inteligência artificial para extrair lançamentos e responder consultas. O Florim também usa inteligência artificial para gerar insights e previsões financeiras com base nos dados registrados. Esse conteúdo é gerado automaticamente, pode conter imprecisões e <strong>não constitui aconselhamento financeiro profissional</strong>.
            </p>
        ...
        content: (
          <>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Imprecisões em lançamentos, respostas ou insights gerados por inteligência artificial</li>
    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              Florim is a family financial organization app that lets users manually record income, expenses, savings goals, and reminders, either directly in the app or through text and audio messages on WhatsApp.
            </p>
            <p>
              Messages sent over WhatsApp are processed using artificial intelligence to extract entries and answer questions. Florim also uses artificial intelligence to generate insights and financial forecasts based on the recorded data. This content is generated automatically, may contain inaccuracies, and <strong>does not constitute professional financial advice</strong>.
            </p>
            <p className="bg-white border border-border rounded-lg px-4 py-3 text-sm">
        ...
        content: (
          <>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Inaccuracies in entries, replies, or insights generated by artificial intelligence</li>
    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <>
            <p>
              Florim es una aplicación de organización financiera familiar que permite a los usuarios registrar manualmente ingresos, gastos, metas de ahorro y recordatorios, ya sea directamente en la app o mediante mensajes de texto y audio en WhatsApp.
            </p>
            <p>
              Los mensajes enviados por WhatsApp se procesan mediante inteligencia artificial para extraer registros y responder consultas. Florim también usa inteligencia artificial para generar perspectivas y previsiones financieras basadas en los datos registrados. Este contenido se genera automáticamente, puede contener imprecisiones y <strong>no constituye asesoramiento financiero profesional</strong>.
            </p>
            <p className="bg-white border border-border rounded-lg px-4 py-3 text-sm">
        ...
        content: (
          <>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>Imprecisiones en registros, respuestas o perspectivas generadas por inteligencia artificial</li>
