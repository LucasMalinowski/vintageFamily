...
Se filtro não for "nenhum": inclua em selected APENAS itens cuja description ou category está diretamente relacionada ao filtro. Se nenhum item corresponde, retorne selected:[].
Se filtro for "nenhum": para "max" inclua todos os itens; para "sum"/"list"/"count" inclua todos relevantes.
